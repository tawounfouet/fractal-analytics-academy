...
*/
/*
SELECT DAYOFWEEK(order_date) as Wday, SUM(final_price) as Total_Revenue, COUNT(order_id) as OrderCount
FROM orders
GROUP BY Wday
ORDER BY Wday;
*/
-- We can observe that saturday and sundays have lower orders compare to weekdays

-- Use case statement to asign Weekend of Weekday to a given day
